        ...
        <>
            ...
            <div className={`sidebar  ${show && 'showSideBar'}`}  >
                ...
                <div className="top-icons">
                    <Link style={{textDecoration: 'none'}} to="/admin"><div className={`icon ${path === '/admin' && 'active'}`}>
                        <FaHome />
                    </div></Link>
                    <Link style={{textDecoration: 'none'}} to="/addProduct"><div className={`icon ${path === '/addProduct' && 'active'}`}>
                        <FaPlus />
                    </div></Link>
                </div>
            ...
            <div className='mainarea admin'>
                ...
                <div className='header'>
                    ...
                    <span style={{ fontSize: "30px", color: "#488630" }}>Hello, {JSON.parse(localStorage.getItem("User")).name}</span>
                </div>
